let COMPONENT_REGISTRY = [
    ...
    },
    {
        ...
        fields: [
            ...
            { name: 'action', label: 'Action Button', type: 'text' }
        ]
    },
    {
        type: 'footer',
...
export async function fetchCustomComponents() {
    try {
        ...
        customComponents.forEach(comp => {
            registerComponent({
                type: comp.name, // The component name (folder name)
                label: comp.label || comp.name,
                subtitle: 'Custom Component',
                icon: 'M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Zm0,18A8,8 0 0,1 4,12A8,8 0 0,1 12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20ZM11,7H13V11H17V13H13V17H11V13H7V11H11V7Z', // Plus icon
