...
import { UponSanitizeAttributeHookEvent, Config, DOMPurify, HookName, UponSanitizeElementHookEvent } from "dompurify";
...
type DOMPurifyInterface = DOMPurify;
type HookEvent = UponSanitizeElementHookEvent | UponSanitizeAttributeHookEvent | null;
...
declare function uponSanitizeAttribute(node: Node, data: UponSanitizeAttributeHookEvent, _config: DOMPurifyConfig): createDOMPurify.UponSanitizeAttributeHookEvent;
declare function blobSanitizer(sandboxKey: SandboxKey): ReturnType<typeof getSanitizerForConfig>;
export { getSanitizerForConfig, sanitizeSvgHref, sanitizeSvgTextReturnDOM, uponSanitizeAttribute, blobSanitizer, BaseDOMPurifyConfigName, DOMPurifyConfig, DOMPurifyInterface, HookEvent, HookCallback, HooksRegistry, NormalizedHref };
export type { HookName, UponSanitizeAttributeHookEvent as SanitizeAttributeHookEvent, UponSanitizeElementHookEvent as SanitizeElementHookEvent };
