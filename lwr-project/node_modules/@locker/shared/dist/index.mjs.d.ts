...
declare const NumberCtor: NumberConstructor;
// Used by '@locker/near-membrane-dom'.
...
declare const trustedResources: Set<string>;
declare function registerTrustedResources(lockerTrustedResources: string[]): void;
