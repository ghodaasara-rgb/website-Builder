...
import { patchGlobalObject as patchGlobalObject$LWS, internalDistortionFactoryInitializers as internalDistortionFactoryInitializers$LWS, internalKeyedDistortionFactoryInitializers as internalKeyedDistortionFactoryInitializers$LWS, externalDistortionFactoryInitializers as externalDistortionFactoryInitializers$LWS, externalKeyedDistortionFactoryInitializers as externalKeyedDistortionFactoryInitializers$LWS, addBlockedAttributeDistortionFactoryInitializers as addBlockedAttributeDistortionFactoryInitializers$LWS, HTMLElementBlockedAttributes as HTMLElementBlockedAttributes$LWS, HTMLIFrameElementBlockedAttributes as HTMLIFrameElementBlockedAttributes$LWS, HTMLScriptElementBlockedAttributes as HTMLScriptElementBlockedAttributes$LWS, SVGElementBlockedAttributes as SVGElementBlockedAttributes$LWS, addBlockedPropertyDistortionFactoryInitializers as addBlockedPropertyDistortionFactoryInitializers$LWS, DataTransferProtoBlockedProperties as DataTransferProtoBlockedProperties$LWS, DocumentBlockedProperties as DocumentBlockedProperties$LWS, DocumentProtoBlockedProperties as DocumentProtoBlockedProperties$LWS, ElementProtoBlockedProperties as ElementProtoBlockedProperties$LWS, EventProtoBlockedProperties as EventProtoBlockedProperties$LWS, HTMLElementProtoBlockedProperties as HTMLElementProtoBlockedProperties$LWS, HTMLIFrameElementProtoBlockedProperties as HTMLIFrameElementProtoBlockedProperties$LWS, HTMLEmbedElementProtoBlockedProperties as HTMLEmbedElementProtoBlockedProperties$LWS, HTMLObjectElementProtoBlockedProperties as HTMLObjectElementProtoBlockedProperties$LWS, HTMLScriptElementProtoBlockedProperties as HTMLScriptElementProtoBlockedProperties$LWS, SVGElementProtoBlockedProperties as SVGElementProtoBlockedProperties$LWS, UIEventProtoBlockedProperties as UIEventProtoBlockedProperties$LWS, WindowBlockedProperties as WindowBlockedProperties$LWS, XSLTProcessorProtoBlockedProperties as XSLTProcessorProtoBlockedProperties$LWS, distortionFactoryInitializerToggleSwitches as distortionFactoryInitializerToggleSwitches$LWS, finalizeAttributeDistortions as finalizeAttributeDistortions$LWS, initDistortionWindowPostMessage as initDistortionWindowPostMessage$LWS } from '@locker/distortion';
...
if (isGaterEnabledFeature$LWS('enableImmediateGlobalObjectPatching')) {
  patchGlobalObject$LWS(rootWindow$1$LWS, rootDocument$LWS);
}
...
function wrapPlatformResourceLoader$LWS(dep$LWS, key$LWS) {
  ...
  secureDep$LWS = {
    loadScript: (cmp$LWS, url$LWS, config$LWS) => {
      ...
      const resourceName$LWS = ReflectApply$1$LWS(StringProtoSplit$LWS, url$LWS, ['/'])[3];
