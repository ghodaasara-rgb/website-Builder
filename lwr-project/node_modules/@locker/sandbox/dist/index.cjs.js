...
if (shared$LWS.isGaterEnabledFeature('enableImmediateGlobalObjectPatching')) {
  distortion$LWS.patchGlobalObject(sharedDom$LWS.rootWindow, sharedDom$LWS.rootDocument);
}
...
function getDistortionFactories$LWS(record$LWS) {
  ...
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, DataTransfer.prototype, distortion$LWS.DataTransferProtoBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, Document$LWS, distortion$LWS.DocumentBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, Document$LWS.prototype, distortion$LWS.DocumentProtoBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, Element$LWS.prototype, distortion$LWS.ElementProtoBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, Event$LWS.prototype, distortion$LWS.EventProtoBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, HTMLElement$LWS.prototype, distortion$LWS.HTMLElementProtoBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, HTMLIFrameElement$LWS.prototype, distortion$LWS.HTMLIFrameElementProtoBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, HTMLEmbedElement.prototype, distortion$LWS.HTMLEmbedElementProtoBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, HTMLObjectElement.prototype, distortion$LWS.HTMLObjectElementProtoBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, HTMLScriptElement$LWS.prototype, distortion$LWS.HTMLScriptElementProtoBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, SVGElement$LWS.prototype, distortion$LWS.SVGElementProtoBlockedProperties, initializers$LWS);
  distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, UIEvent$LWS.prototype, distortion$LWS.UIEventProtoBlockedProperties, initializers$LWS);
  ...
  if (typeof XSLTProcessor$LWS === 'function') {
    distortion$LWS.addBlockedPropertyDistortionFactoryInitializers(record$LWS, XSLTProcessor$LWS.prototype, distortion$LWS.XSLTProcessorProtoBlockedProperties, initializers$LWS);
  }
...
function wrapPlatformResourceLoader$LWS(dep$LWS, key$LWS) {
  ...
  secureDep$LWS = {
    loadScript: (cmp$LWS, url$LWS, config$LWS) => {
      ...
      const resourceName$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoSplit, url$LWS, ['/'])[3];
      if (config$LWS != null && config$LWS.trustedMode && shared$LWS.trustedResources.has(resourceName$LWS)) {
