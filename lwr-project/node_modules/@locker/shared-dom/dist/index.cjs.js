...
class Validator$LWS {
  constructor(document$LWS, {
    ...
    this.isInherentlyUnsecure = input$LWS => {
      const normalizedInput$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoToLowerCase, shared$LWS.toSafeStringValue(input$LWS), []);
      const hasIframe$LWS = hasTag$LWS(normalizedInput$LWS, 'iframe') && shared$LWS.ReflectApply(shared$LWS.StringProtoIncludes, normalizedInput$LWS, ['srcdoc']);
      ...
      shared$LWS.ReflectApply(ElementProtoInnerHTMLSetter$LWS, rootDocumentDetachedContainer$LWS, [normalizedInput$LWS]);
...
function hasTag$LWS(input$LWS, tag$LWS) {
  ...
  if (shared$LWS.isGaterEnabledFeature('changesSince.256')) {
    const lowerCasedInput$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoToLowerCase, input$LWS, []);
    checkableInput$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoReplace, lowerCasedInput$LWS, [/\s+/g, ' ']);
  }
  return shared$LWS.ReflectApply(shared$LWS.StringProtoIncludes, checkableInput$LWS, [`<${tag$LWS} `]) || shared$LWS.ReflectApply(shared$LWS.StringProtoIncludes, checkableInput$LWS, [`:${tag$LWS} `]) || shared$LWS.ReflectApply(shared$LWS.StringProtoIncludes, checkableInput$LWS, [`<${tag$LWS}>`]) || shared$LWS.ReflectApply(shared$LWS.StringProtoIncludes, checkableInput$LWS, [`:${tag$LWS}>`]);
}
