...
class Validator$LWS {
  constructor(document$LWS, {
    ...
    this.isInherentlyUnsecure = input$LWS => {
      const normalizedInput$LWS = ReflectApply$LWS(StringProtoToLowerCase$LWS, toSafeStringValue$LWS(input$LWS), []);
      const hasIframe$LWS = hasTag$LWS(normalizedInput$LWS, 'iframe') && ReflectApply$LWS(StringProtoIncludes$LWS, normalizedInput$LWS, ['srcdoc']);
      ...
      ReflectApply$LWS(ElementProtoInnerHTMLSetter$LWS, rootDocumentDetachedContainer$LWS, [normalizedInput$LWS]);
...
function hasTag$LWS(input$LWS, tag$LWS) {
  ...
  if (isGaterEnabledFeature$LWS('changesSince.256')) {
    const lowerCasedInput$LWS = ReflectApply$LWS(StringProtoToLowerCase$LWS, input$LWS, []);
    checkableInput$LWS = ReflectApply$LWS(StringProtoReplace$LWS, lowerCasedInput$LWS, [/\s+/g, ' ']);
  }
  return ReflectApply$LWS(StringProtoIncludes$LWS, checkableInput$LWS, [`<${tag$LWS} `]) || ReflectApply$LWS(StringProtoIncludes$LWS, checkableInput$LWS, [`:${tag$LWS} `]) || ReflectApply$LWS(StringProtoIncludes$LWS, checkableInput$LWS, [`<${tag$LWS}>`]) || ReflectApply$LWS(StringProtoIncludes$LWS, checkableInput$LWS, [`:${tag$LWS}>`]);
}
