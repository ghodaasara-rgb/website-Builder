...
declare const DataTransferProtoBlockedProperties: readonly string[];
...
declare const DocumentProtoBlockedProperties: readonly string[];
declare function finalizeAttributeDistortions(record: SandboxRecord): void;
declare const ElementProtoBlockedProperties: readonly string[];
declare const EventProtoBlockedProperties: readonly string[];
declare const HTMLElementBlockedAttributes: readonly string[];
declare const HTMLElementProtoBlockedProperties: readonly string[];
declare const HTMLEmbedElementProtoBlockedProperties: readonly string[];
// https://www.w3schools.com/tags/tag_iframe.asp
declare const HTMLIFrameElementBlockedAttributes: readonly string[];
declare const HTMLIFrameElementProtoBlockedProperties: readonly string[];
declare const HTMLObjectElementProtoBlockedProperties: readonly string[];
declare const HTMLScriptElementBlockedAttributes: readonly string[];
declare const HTMLScriptElementProtoBlockedProperties: readonly string[];
declare const SVGElementBlockedAttributes: readonly string[];
declare const SVGElementProtoBlockedProperties: readonly string[];
declare const UIEventProtoBlockedProperties: readonly string[];
