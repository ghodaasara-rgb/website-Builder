  ...
  return function distortionElementSetHTMLUnsafe$LWS({
    ...
    return [originalSetHTMLUnsafe$LWS, function setHTMLUnsafe$LWS(value$LWS) {
      ...
      if (!isOwnerXMLDocument$LWS) {
        ...
        if (this instanceof HTMLScriptElement$LWS || this instanceof SVGScriptElement) {
          const scriptWasNotEvaluatedInScriptPropertySetter$LWS = scriptPropertySetters$LWS(this, 'innerHTML', trusted$LWS.createScript(normalizedValue$LWS), originalInnerHTMLGetter$LWS, originalInnerHTMLSetter$LWS, distortions$LWS, sandboxEvaluator$LWS, trusted$LWS.createScript(SCRIPT_HOOK_SOURCE_TEXT$LWS));
          if (scriptWasNotEvaluatedInScriptPropertySetter$LWS) {
            return;
          }
        }
      ...
      ReflectApply$LWS(originalSetHTMLUnsafe$LWS, this, [normalizedValue$LWS]);
    }];
  };
}
...
function initDistortionPromiseTry$LWS({
  ...
  const distortionEntry$LWS = [originalPromiseTry$LWS, function (...args$LWS) {
    ...
    return ReflectApply$LWS(originalPromiseTry$LWS, this, args$LWS);
  }];
...
function containsEval$LWS(obj$LWS, originalEval$LWS) {
  ...
  if (typeof obj$LWS === 'object' && obj$LWS !== null) {
    for (const key$LWS in obj$LWS) {
      if (ObjectHasOwn$LWS(obj$LWS, key$LWS)) {
...
function initDistortionWebAssemblyInstanceExportsGetter$LWS({
  ...
  const originalExportsGetter$LWS = ObjectLookupOwnGetter$LWS(WebAssemblyInstance$LWS.prototype, 'exports');
  const distortionEntry$LWS = [originalExportsGetter$LWS, function exportsGetter$LWS() {
    const exportsGetterThis$LWS = this;
    const actualExportsDescriptors$LWS = ObjectGetOwnPropertyDescriptors$LWS(ReflectApply$LWS(originalExportsGetter$LWS, this, []));
    const actualExportsKeys$LWS = ObjectKeys$LWS(actualExportsDescriptors$LWS);
    ...
    for (const key$LWS of actualExportsKeys$LWS) {
      ...
      if (typeof originalValue$LWS === 'function') {
        ...
        safeDescriptor$LWS.value = function (...args$LWS) {
          ...
          return ReflectApply$LWS(originalValue$LWS, exportsGetterThis$LWS, args$LWS);
        };
        ReflectDefineProperty$LWS(wrappedExports$LWS, key$LWS, safeDescriptor$LWS);
      } else {
        ReflectDefineProperty$LWS(wrappedExports$LWS, key$LWS, descriptor$LWS);
      }
    }
...
function initDistortionWebAssemblyInstantiate$LWS({
  ...
  return function distortionWebAssemblyInstantiate$LWS() {
    return [originalInstantiate$LWS, function instantiate$LWS(...args$LWS) {
      ...
      return ReflectApply$LWS(originalInstantiate$LWS, this, args$LWS);
    }];
  };
}
function initDistortionWebAssemblyInstantiateStreaming$LWS({
  ...
  return function distortionWebAssemblyInstantiateStreaming$LWS() {
    return [originalInstantiateStreaming$LWS, function instantiateStreaming$LWS(...args$LWS) {
      ...
      return ReflectApply$LWS(originalInstantiateStreaming$LWS, this, args$LWS);
    }];
  };
}
...
function initDistortionWindowFetchLater$LWS({
  ...
  const distortionEntry$LWS = [originalFetchLater$LWS, function fetchLater$LWS(...args$LWS) {
    if (!isGaterEnabledFeature$LWS('changesSince.258')) {
      return ReflectApply$LWS(originalFetchLater$LWS, this, args$LWS);
    }
    // Let the native method handle missing parameters error or null/undefined URL case.
    let {
      0: url$LWS
...
export { DataTransferProtoBlockedProperties$LWS as DataTransferProtoBlockedProperties, DocumentBlockedProperties$LWS as DocumentBlockedProperties, DocumentProtoBlockedProperties$LWS as DocumentProtoBlockedProperties, ElementProtoBlockedProperties$LWS as ElementProtoBlockedProperties, EventProtoBlockedProperties$LWS as EventProtoBlockedProperties, HTMLElementBlockedAttributes$LWS as HTMLElementBlockedAttributes, HTMLElementProtoBlockedProperties$LWS as HTMLElementProtoBlockedProperties, HTMLEmbedElementProtoBlockedProperties$LWS as HTMLEmbedElementProtoBlockedProperties, HTMLIFrameElementBlockedAttributes$LWS as HTMLIFrameElementBlockedAttributes, HTMLIFrameElementProtoBlockedProperties$LWS as HTMLIFrameElementProtoBlockedProperties, HTMLObjectElementProtoBlockedProperties$LWS as HTMLObjectElementProtoBlockedProperties, HTMLScriptElementBlockedAttributes$LWS as HTMLScriptElementBlockedAttributes, HTMLScriptElementProtoBlockedProperties$LWS as HTMLScriptElementProtoBlockedProperties, SVGElementBlockedAttributes$LWS as SVGElementBlockedAttributes, SVGElementProtoBlockedProperties$LWS as SVGElementProtoBlockedProperties, UIEventProtoBlockedProperties$LWS as UIEventProtoBlockedProperties, WindowBlockedProperties$LWS as WindowBlockedProperties, XSLTProcessorProtoBlockedProperties$LWS as XSLTProcessorProtoBlockedProperties, addBlockedAttributeDistortionFactoryInitializers$LWS as addBlockedAttributeDistortionFactoryInitializers, addBlockedPropertyDistortionFactoryInitializers$LWS as addBlockedPropertyDistortionFactoryInitializers, distortionFactoryInitializerToggleSwitches$LWS as distortionFactoryInitializerToggleSwitches, externalDistortionFactoryInitializers$LWS as externalDistortionFactoryInitializers, externalKeyedDistortionFactoryInitializers$LWS as externalKeyedDistortionFactoryInitializers, finalizeAttributeDistortions$LWS as finalizeAttributeDistortions, initDistortionWindowPostMessage$LWS as initDistortionWindowPostMessage, internalDistortionFactoryInitializers$LWS as internalDistortionFactoryInitializers, internalKeyedDistortionFactoryInitializers$LWS as internalKeyedDistortionFactoryInitializers, patchGlobalObject$LWS as patchGlobalObject, unpatchGlobalObject$LWS as unpatchGlobalObject };
/*! version: 0.26.2 */
