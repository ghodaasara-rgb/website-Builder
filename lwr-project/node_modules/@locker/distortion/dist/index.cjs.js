...
function initDistortionDocumentOpen$LWS({
  ...
  const distortionEntry$LWS = [originalDocumentOpen$LWS, function open$LWS(...args$LWS) {
    ...
    if (length$LWS >= 3) {
      ...
      if (shared$LWS.isGaterEnabledFeature('changesSince.256')) {
  ...
  return function distortionDOMParserParseFromString$LWS({
    ...
    return [originalParseFromString$LWS, function parseFromString$LWS(...args$LWS) {
      ...
      if (args$LWS.length >= 2) {
        ...
        setCustomElementsRegistry$LWS(document$LWS, key$LWS);
        const trustedHtml$LWS = internalPolicy$LWS.lwsInternalPolicy.createHTML(string$LWS, key$LWS, contentType$LWS);
        if (contentType$LWS === internalPolicy$LWS.ContentType.XML) {
          if (isInherentlyUnsecure$LWS(trustedHtml$LWS)) {
            throw new shared$LWS.LockerSecurityError(`Cannot 'parseFromString' using an unsecure ${shared$LWS.toSafeTemplateStringValue(trustedHtml$LWS)}.`);
          }
        }
    ...
    return [originalInsertAdjacentHTML$LWS, function insertAdjacentHTML$LWS(...args$LWS) {
      ...
      if (args$LWS.length > 1) {
        ...
        if (isInherentlyUnsecure$3$LWS(args$LWS[1])) {
          throw new shared$LWS.LockerSecurityError(`Cannot set 'insertAdjacentHTML' using an unsecure ${shared$LWS.toSafeTemplateStringValue(args$LWS[1])}.`);
        }
      }
...
function initDistortionElementOuterHTMLSetter$LWS({
  ...
  return function distortionElementOuterHTMLSetter$LWS({
    ...
    return [originalOuterHTMLSetter$LWS, function outerHTML$LWS(value$LWS) {
      ...
      if (shared$LWS.isGaterEnabledFeature('changesSince.260')) {
        if (isInherentlyUnsecure$2$LWS(html$LWS)) {
          throw new shared$LWS.LockerSecurityError(`Cannot set 'outerHTML' using an unsecure ${shared$LWS.toSafeTemplateStringValue(value$LWS)}.`);
        }
      }
...
function initDistortionElementSetHTML$LWS({
  ...
  return function distortionElementSetHTML$LWS({
    ...
    return [originalSetHTML$LWS, function setHTML$LWS(...args$LWS) {
      const isOwnerXMLDocument$LWS = shared$LWS.ReflectApply(sharedDom$LWS.NodeProtoOwnerDocumentGetter, this, []) instanceof XMLDocument$LWS;
      if (!isOwnerXMLDocument$LWS) {
        const normalizedValue$LWS = shared$LWS.toSafeStringValue(args$LWS[0]);
        // istanbul ignore else: needs default platform behavior test
        ...
        const contentType$LWS = this instanceof SVGElement$LWS ? internalPolicy$LWS.ContentType.SVG : internalPolicy$LWS.ContentType.HTML;
        args$LWS[0] = internalPolicy$LWS.lwsInternalPolicy.createHTML(normalizedValue$LWS, key$LWS, contentType$LWS);
...
function initDistortionElementSetHTMLUnsafe$LWS({
  ...
  return function distortionElementSetHTMLUnsafe$LWS({
    ...
    return [originalSetHTMLUnsafe$LWS, function setHTMLUnsafe$LWS(value$LWS) {
      let normalizedValue$LWS = shared$LWS.toSafeStringValue(value$LWS);
      const isOwnerXMLDocument$LWS = shared$LWS.ReflectApply(sharedDom$LWS.NodeProtoOwnerDocumentGetter, this, []) instanceof XMLDocument$LWS;
      if (!isOwnerXMLDocument$LWS) {
        // istanbul ignore else: needs default platform behavior test
        ...
        if (this instanceof HTMLScriptElement$LWS || this instanceof SVGScriptElement) {
          const scriptWasNotEvaluatedInScriptPropertySetter$LWS = scriptPropertySetters$LWS(this, 'innerHTML', trustedTypes$LWS.trusted.createScript(normalizedValue$LWS), originalInnerHTMLGetter$LWS, originalInnerHTMLSetter$LWS, distortions$LWS, sandboxEvaluator$LWS, trustedTypes$LWS.trusted.createScript(sharedDom$LWS.SCRIPT_HOOK_SOURCE_TEXT));
          if (scriptWasNotEvaluatedInScriptPropertySetter$LWS) {
            return;
          }
        }
        ...
        setCustomElementsRegistry$LWS(document$LWS, key$LWS);
        const contentType$LWS = this instanceof SVGElement$LWS ? internalPolicy$LWS.ContentType.SVG : internalPolicy$LWS.ContentType.HTML;
        normalizedValue$LWS = internalPolicy$LWS.lwsInternalPolicy.createHTML(normalizedValue$LWS, key$LWS, contentType$LWS);
      }
      if (isInherentlyUnsecure$LWS(normalizedValue$LWS)) {
        throw new shared$LWS.LockerSecurityError(`Cannot 'setHTMLUnsafe' using an unsecure ${shared$LWS.toSafeTemplateStringValue(normalizedValue$LWS)}.`);
      }
      shared$LWS.ReflectApply(originalSetHTMLUnsafe$LWS, this, [normalizedValue$LWS]);
    }];
  };
}
...
function initDistortionHTMLIFrameElementSrcSetter$LWS({
  ...
  return function distortionHTMLIFrameElementSrcSetter$LWS(record$LWS) {
    function src$LWS(value$LWS) {
      ...
      if (shared$LWS.isGaterEnabledFeature('changesSince.258')) {
        ...
        if (!sharedUrl$LWS.isValidURL(parsedURL$LWS)) {
          ...
          throw new shared$LWS.LockerSecurityError(`Cannot request disallowed endpoint: ${shared$LWS.toSafeTemplateStringValue(normalizedURL$LWS)}`);
        }
      }
...
function initDistortionHTMLScriptElementTextContentGetter$LWS({
  ...
  if (!shared$LWS.isGaterEnabledFeature('changesSince.256') || !descriptor$LWS) {
    return shared$LWS.noop;
  }
...
function initDistortionPromiseTry$LWS({
  ...
  const distortionEntry$LWS = [originalPromiseTry$LWS, function (...args$LWS) {
    ...
    return shared$LWS.ReflectApply(originalPromiseTry$LWS, this, args$LWS);
  }];
...
function containsEval$LWS(obj$LWS, originalEval$LWS) {
  ...
  if (typeof obj$LWS === 'object' && obj$LWS !== null) {
    for (const key$LWS in obj$LWS) {
      if (shared$LWS.ObjectHasOwn(obj$LWS, key$LWS)) {
...
function initDistortionWebAssemblyInstanceExportsGetter$LWS({
  ...
  const originalExportsGetter$LWS = shared$LWS.ObjectLookupOwnGetter(WebAssemblyInstance$LWS.prototype, 'exports');
  const distortionEntry$LWS = [originalExportsGetter$LWS, function exportsGetter$LWS() {
    const exportsGetterThis$LWS = this;
    const actualExportsDescriptors$LWS = shared$LWS.ObjectGetOwnPropertyDescriptors(shared$LWS.ReflectApply(originalExportsGetter$LWS, this, []));
    const actualExportsKeys$LWS = shared$LWS.ObjectKeys(actualExportsDescriptors$LWS);
    ...
    for (const key$LWS of actualExportsKeys$LWS) {
      ...
      if (typeof originalValue$LWS === 'function') {
        ...
        safeDescriptor$LWS.value = function (...args$LWS) {
          if (shared$LWS.isGaterEnabledFeature('changesSince.260') && containsEval$LWS(args$LWS, originalEval$LWS)) {
            throw new shared$LWS.LockerSecurityError(`Cannot call WebAssembly.Instance exported function with eval.`);
          }
          return shared$LWS.ReflectApply(originalValue$LWS, exportsGetterThis$LWS, args$LWS);
        };
        shared$LWS.ReflectDefineProperty(wrappedExports$LWS, key$LWS, safeDescriptor$LWS);
      } else {
        shared$LWS.ReflectDefineProperty(wrappedExports$LWS, key$LWS, descriptor$LWS);
      }
    }
    ...
    return [originalInstantiate$LWS, function instantiate$LWS(...args$LWS) {
      ...
      if (length$LWS > 1) {
        ...
        if (importObject$LWS !== undefined && importObject$LWS !== null) {
          if (shared$LWS.isGaterEnabledFeature('changesSince.260') && containsEval$LWS(importObject$LWS, originalEval$LWS)) {
            throw new shared$LWS.LockerSecurityError('WebAssembly.instantiate: Import object contains eval, which is not allowed.');
          }
        }
      }
      return shared$LWS.ReflectApply(originalInstantiate$LWS, this, args$LWS);
    }];
  };
}
  ...
  return function distortionWebAssemblyInstantiateStreaming$LWS() {
    return [originalInstantiateStreaming$LWS, function instantiateStreaming$LWS(...args$LWS) {
      ...
      if (length$LWS > 1) {
        ...
        if (importObject$LWS !== undefined && importObject$LWS !== null) {
          if (shared$LWS.isGaterEnabledFeature('changesSince.260') && containsEval$LWS(importObject$LWS, originalEval$LWS)) {
            throw new shared$LWS.LockerSecurityError('WebAssembly.instantiateStreaming: Import object contains eval, which is not allowed.');
          }
        }
      }
      return shared$LWS.ReflectApply(originalInstantiateStreaming$LWS, this, args$LWS);
    }];
  };
}
...
function initDistortionWindowFetchLater$LWS({
  ...
  const distortionEntry$LWS = [originalFetchLater$LWS, function fetchLater$LWS(...args$LWS) {
    if (!shared$LWS.isGaterEnabledFeature('changesSince.258')) {
      return shared$LWS.ReflectApply(originalFetchLater$LWS, this, args$LWS);
    }
    // Let the native method handle missing parameters error or null/undefined URL case.
    let {
      0: url$LWS
...
exports.DataTransferProtoBlockedProperties = DataTransferProtoBlockedProperties$LWS;
exports.DocumentBlockedProperties = DocumentBlockedProperties$LWS;
exports.DocumentProtoBlockedProperties = DocumentProtoBlockedProperties$LWS;
exports.ElementProtoBlockedProperties = ElementProtoBlockedProperties$LWS;
exports.EventProtoBlockedProperties = EventProtoBlockedProperties$LWS;
exports.HTMLElementBlockedAttributes = HTMLElementBlockedAttributes$LWS;
exports.HTMLElementProtoBlockedProperties = HTMLElementProtoBlockedProperties$LWS;
exports.HTMLEmbedElementProtoBlockedProperties = HTMLEmbedElementProtoBlockedProperties$LWS;
exports.HTMLIFrameElementBlockedAttributes = HTMLIFrameElementBlockedAttributes$LWS;
exports.HTMLIFrameElementProtoBlockedProperties = HTMLIFrameElementProtoBlockedProperties$LWS;
exports.HTMLObjectElementProtoBlockedProperties = HTMLObjectElementProtoBlockedProperties$LWS;
exports.HTMLScriptElementBlockedAttributes = HTMLScriptElementBlockedAttributes$LWS;
exports.HTMLScriptElementProtoBlockedProperties = HTMLScriptElementProtoBlockedProperties$LWS;
exports.SVGElementBlockedAttributes = SVGElementBlockedAttributes$LWS;
exports.SVGElementProtoBlockedProperties = SVGElementProtoBlockedProperties$LWS;
exports.UIEventProtoBlockedProperties = UIEventProtoBlockedProperties$LWS;
exports.WindowBlockedProperties = WindowBlockedProperties$LWS;
exports.XSLTProcessorProtoBlockedProperties = XSLTProcessorProtoBlockedProperties$LWS;
