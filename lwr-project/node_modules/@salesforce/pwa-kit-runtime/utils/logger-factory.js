...
class PWAKitLogger {
  ...
  #serializeError(object) {
    const obj = _objectSpread({}, object);
  ...
  #formatLogMessage(message, {
    ...
    return `${finalNamespace} ${level.toUpperCase()} ${message}${additionalProperties ? ` ${JSON.stringify(this.#serializeError(additionalProperties))}` : ''}`;
  }
