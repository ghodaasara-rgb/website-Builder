...
var HistoryRouter = class extends import_domRouter.DomRouterImpl {
  ...
  onpopstate() {
    if (!this.parent && import_routerUtils.hasDocument) {
      const relativeUrl = (0, import_domRouterUtils.getRelativeUrl)(window.location.href);
      const hashlessUrl = this.router.basePath.includes("#") ? relativeUrl : (0, import_domRouterUtils.removeFragment)(relativeUrl);
