...
export default class AppModuleProvider {
    ...
    async getModuleSource({ specifier, namespace, name, }) {
        ...
        if (!moduleEntry || !route) {
            throw new LwrUnresolvableError(descriptions.UNRESOLVABLE.MODULE(specifier), 'module');
        }
        ...
        if (appIdentity.subResource && isWorkerSubResource(appIdentity.subResource)) {
            ...
            if (!workerSpecifier) {
                throw new LwrUnresolvableError(descriptions.UNRESOLVABLE.MODULE(workerSpecifier), 'module');
            }
