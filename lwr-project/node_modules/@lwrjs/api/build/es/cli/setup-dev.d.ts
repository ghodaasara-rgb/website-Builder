import type { SitesLocalDevOptions } from '@lwrjs/types';
/**
 ...
 */
export declare const MIN_SUPPORTED_VERSION = "0.13.0";
export declare function injectLocalDevHacks(filePath: string): void;
/**
 * Generic api for automated setup of an MRT bundle.
 *
 * @param options
 */
export declare function setupDev(options: SitesLocalDevOptions): Promise<void>;
//# sourceMappingURL=setup-dev.d.ts.map