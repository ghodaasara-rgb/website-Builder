...
__export(exports, {
  ...
  injectLocalDevHacks: () => injectLocalDevHacks,
  setupDev: () => setupDev
});
...
function injectLocalDevHacks(filePath) {
  try {
    ...
    import_fs_extra.default.writeFileSync(filePath, newestContent, "utf8");
  } catch (error) {
...
async function setupDev(options) {
  ...
  injectLocalDevHacks(import_path.default.join(pathToAppFolder, "experience", "index_csr.html"));
  injectLocalDevHacks(import_path.default.join(pathToAppFolder, "experience", "index.html"));
  injectLocalDevHacks(import_path.default.join(pathToAppFolder, "site", "dev", "module", "@app", "authenticationCookieName.js"));
  injectLocalDevHacks(import_path.default.join(pathToAppFolder, "site", "prod", "module", "@app", "authenticationCookieName.js"));
  injectLocalDevHacks(import_path.default.join(pathToAppFolder, "site", "dev", "module", "@app", "imageOpt.js"));
  injectLocalDevHacks(import_path.default.join(pathToAppFolder, "site", "prod", "module", "@app", "imageOpt.js"));
}
