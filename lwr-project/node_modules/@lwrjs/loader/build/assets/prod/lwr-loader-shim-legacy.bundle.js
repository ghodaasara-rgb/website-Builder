...
(function () {
  ...
  class LoaderShim {
      ...
      constructor(global) {LoaderShim.prototype.__init.call(this);LoaderShim.prototype.__init2.call(this);
          ...
          this.loaderModule = 'lwr/loaderLegacy/v/0_21_4';
  ...
  if (GLOBAL.LWR.requiredModules.indexOf('lwr/loaderLegacy/v/0_21_4') < 0) {
      GLOBAL.LWR.requiredModules.push('lwr/loaderLegacy/v/0_21_4');
  }
  new LoaderShim(GLOBAL);

})();

LWR.define('lwr/loaderLegacy/v/0_21_4', ['exports'], (function (exports) { 'use strict';
    ...
    async function yieldToMainThread() {
      ...
      // eslint-disable-next-line lwr/no-unguarded-apis
      return _optionalChain$1([scheduler, 'optionalAccess', _ => _.yield]) ? scheduler.yield() : new Promise(resolve => setTimeout(resolve, 0));
    }
    ...
    class Loader {
        ...
        async load(id, importer) {
            ...
            // Throw an error if the specifier is "lwr/loaderLegacy" or versioned and the importer is defined
            // Nobody should be dynamically importing the LWR loader; it is an app-level API
            if ((id === 'lwr/loaderLegacy' || id.startsWith('lwr/loaderLegacy/v/')) && importer !== undefined) {
